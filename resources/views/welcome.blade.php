...
@section('content')
    ...
    <body>
        <section class="relative bg-cover bg-center h-screen"
            style="background-image: url(https://images.pexels.com/photos/3201763/pexels-photo-3201763.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1);">
            ...
            <div class="relative z-10 flex flex-col items-center justify-center h-full text-white">
                ...
                <a href="/register" class="bg-teal-700 px-6 py-3 rounded-full text-white hover:bg-teal-900">Book Now</a>
            </div>
        </section>
            ...
            <div class="container mx-auto text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-gray-100 p-6 rounded-lg shadow-lg">
                        <img
                            src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/447357319.jpg?k=910a068901eab1d1b31d1463fc04d2ede1633730ceab34ac4cadc96107c06e06&o=">
